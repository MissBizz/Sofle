 ...
 * |  `   |   J  |   G  |   M  |   P  |   V  |                    |   6  |   .  |   /  |   "  |   0  | F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |   R  |   S  |   N  |   D  |   B  |-------.    ,-------|   ,  |   A  |   E  |   I  |   H  |   |  |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * | Shift|  X   |  F   |  L   |   C  |   W  |-------|    |-------|   [  |   U  |   O  |   Y  |   K  | Shift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |  T   | /Enter  /       \Space \  |RAISE | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[1] = LAYOUT(
  QK_BOOT,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
  KC_GRV,    KC_J,    KC_G,    KC_M,    KC_P,    KC_V,                       KC_6,    KC_DOT,    KC_SLSH,    KC_QUOT,    KC_0,  KC_F12,
  _______, KC_R,   KC_S, KC_N,  KC_D, KC_B,                       KC_COMM, KC_A, KC_E, KC_I, KC_H, KC_PIPE,
  _______,  KC_X, KC_F, KC_L, KC_C, KC_W, _______,         _______, KC_LBRC, KC_U, KC_O, KC_Y, KC_K, _______,
